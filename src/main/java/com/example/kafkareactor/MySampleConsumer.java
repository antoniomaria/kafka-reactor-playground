...
import reactor.kafka.samples.SampleProducer;
 ...
 *   <li> Run {@link reactor.kafka.samples.SampleConsumer} as Java application with all dependent jars in the CLASSPATH (eg. from IDE).
 *   <li> Shutdown Kafka server and Zookeeper when no longer required
 * </ol>
 */
public class MySampleConsumer {

    private static final Logger log = LoggerFactory.getLogger(reactor.kafka.samples.SampleConsumer.class.getName());
    ...
    public MySampleConsumer(String bootstrapServers) {
        ...
        props.put(ConsumerConfig.FETCH_MAX_WAIT_MS_CONFIG, 550);
    ...
    public static void main(String[] args) throws Exception {
        ...
        MySampleConsumer consumer = new MySampleConsumer(BOOTSTRAP_SERVERS);
