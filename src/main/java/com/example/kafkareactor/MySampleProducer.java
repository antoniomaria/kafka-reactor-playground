 ...
 *   <li> Run {@link reactor.kafka.samples.SampleProducer} as Java application with all dependent jars in the CLASSPATH (eg. from IDE).
 *   <li> Shutdown Kafka server and Zookeeper when no longer required
 * </ol>
 */
public class MySampleProducer {

    private static final Logger log = LoggerFactory.getLogger(reactor.kafka.samples.SampleProducer.class.getName());
    ...
    public MySampleProducer(String bootstrapServers) {
    ...
    public void sendMessages(String topic, int count, CountDownLatch latch) throws InterruptedException {
        sender.<Integer>send(Flux.range(1, count)
                ...
                .subscribe(r -> {
                    ...
                    System.out.println("sevilla My timestamp: " + timestamp);
    ...
    public static void main(String[] args) throws Exception {
        ...
        MySampleProducer producer = new MySampleProducer(BOOTSTRAP_SERVERS);
